...
var MoviesService = (function () {
    ...
    MoviesService.prototype.calculation = function (movie) {
        console.log("calculation called");
        var total = 0;
        var count = 0;
        var rating = 0;
        for (var _i = 0, _a = movie.ratelist; _i < _a.length; _i++) {
            var x = _a[_i];
    ...
    MoviesService.prototype.getsearchresult = function (str) {
...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                _this.authService.storeUserData(data.token, data.user);
                _this.flashMessageService.show("Succesfully logged into system", { cssClass: 'alert-success', timeout: 3000 });
                console.log("Succesfully logged in");
                _this.router.navigate(['']);
            }
            else {
                _this.flashMessageService.show("Incorrect Username or Password", { cssClass: 'alert-danger', timeout: 3000 });
            ...
            if (_this.authService.loggedIn()) {
                _this.authService.getProfile().subscribe(function (res) {
                    ...
                    if (_this.r == "0") {
                        ...
                        _this._moviesServices.calculation(_this.movie).subscribe(function (res) {
                            console.log(res);
                            _this.rating = res.value;
                        });
                    }
                });
            }
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessagesService.show('User Registered Successfully', { cssClass: 'alert-success', timeout: 3000 });
                console.log("User Registered");
                _this.router.navigate(['login']);
            }
            else {
                _this.flashMessagesService.show('User Registration fail', { cssClass: 'alert-danger', timeout: 3000 });
...
var SearchResultComponent = (function () {
    ...
    SearchResultComponent.prototype.ngOnInit = function () {
        ...
        this.router.params.subscribe(function (params) {
            if (params['cat'] == "top") {
                _this.moviesService.getToprated().subscribe(function (res) {
                    _this.dramabycat = res;
                    _this.name = "Top rated Dramas";
                });
            }
            else if (params['cat'] == "popular") {
                _this.moviesService.getPopular().subscribe(function (res) {
                    _this.dramabycat = res;
                    _this.name = "Popular Dramas";
                });
            }
            else if (params['cat'].startsWith("cat_")) {
                _this.moviesService.getByCatagory(params['cat'].substring(4)).subscribe(function (res) {
                    _this.dramabycat = res;
                    _this.name = params['cat'].substring(4) + " dramas";
                });
            }
            else {
                _this.moviesService.getsearchresult(params['cat']).subscribe(function (res) {
                    _this.dramabycat = res;
                    _this.name = "Search Results for '" + params['cat'] + "'";
                    if (res == "") {
                        _this.name = "no results found";
                    }
                });
            }
        });
